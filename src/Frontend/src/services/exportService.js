 ...
 */
export function exportModelAsJSON(model, fileName) {
 ...
 */
export function exportModelAsPNG(model, fileName) {
 ...
 */
export function exportModelAsJPG(model, fileName, quality = 0.9) {
    const canvas = document.createElement('canvas');
 ...
 */
export function exportModelAsWebP(model, fileName, quality = 0.9) {
    const canvas = document.createElement('canvas');
    canvas.width = model.width;
    canvas.height = model.height;
    const ctx = canvas.getContext('2d');
